...
from yt.frontends.amrvac.tables import ionisation_tables
...
def block_interpolate_ionisation_f(block, dataset):
    ...
    temp = block["temperature"]#*dataset.units.unit_temperature
    pg = block["thermal_pressure"]#*dataset.units.unit_pressure
